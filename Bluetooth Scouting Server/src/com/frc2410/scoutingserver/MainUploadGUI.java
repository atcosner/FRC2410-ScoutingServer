...
public class MainUploadGUI extends JFrame implements ActionListener,WindowListener
{
	...
	public MainUploadGUI(JPanel p1)
	{
	    ...
	    startScouting = new JButton("Begin Match Upload");
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		if(arg0.getActionCommand().equals("Begin Match Upload"))
		{
			...
			if(numConnected >= 1)
			{
				...
				{
					MainThread.uploadQueues[0].push(redTeams[0]);
				}
				if(MainThread.uploadQueues[1] != null)
				{
					MainThread.uploadQueues[1].push(redTeams[1]);
				}
				if(MainThread.uploadQueues[2] != null)
				{
					MainThread.uploadQueues[2].push(redTeams[2]);
				}
				if(MainThread.uploadQueues[3] != null)
				{
					MainThread.uploadQueues[3].push(blueTeams[0]);
				}
				if(MainThread.uploadQueues[4] != null)
				{
					MainThread.uploadQueues[4].push(blueTeams[1]);
				}
				if(MainThread.uploadQueues[5] != null)
				{
					MainThread.uploadQueues[5].push(blueTeams[2]);
				}

				//Start GUI To Show Client Connection Status
				ScoutingUploadGUI sG = new ScoutingUploadGUI(new JPanel(null),MainThread.uploadStatusFields,numConnected,"Match");
				sG.setVisible(true);
